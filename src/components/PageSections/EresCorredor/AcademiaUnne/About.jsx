      ...
      <Fade delay={300} direction="right">
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
          ...
          <div className="col-span-2 flex flex-col justify-center mx-4 xl:ml-24">
            <h2 className="text-2xl xl:text-5xl text-center xl:text-start text-orange-500 font-bold mt-10 xl:my-0">
              ¿Quiénes somos?
            </h2>
            <p className="text-lg xl:text-xl text-gray-700 mt-8 ml-0 xl:ml-5">
              ...
              acceder <br />
              a herramientas digitales que de otro modo seria difícil de
              acceder.
              <br />
                ...
                <div className="w-full xl:w-5/6 h-50 sm:h-auto bg-orange-400 rounded-[50px] overflow-hidden shadow-md">
                  <div className="p-14 pl-10">
                    ...
                    <p className="text-lg xl:text-xl text-white ">
                      ...
                      publicaciones mensuales + de 300 corredores ya son parte
                      de Unne Màs de 6.000 propiedades vigentes en cartera
                    </p>
                  </div>
                </div>
              </div>
