                    ...
                    <div className="bg-white  rounded-md overflow-hidden">
                        <div className="p-4">
                            ...
                            <div className="flex justify-center items-center mt-8">
                                <div className="rounded-full h-12 w-12 flex justify-center items-center bg-gray-200 mr-4">
