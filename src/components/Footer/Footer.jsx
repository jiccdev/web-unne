    ...
    <footer className="bg-gray-100 pt-10 pb-20">
      <div className="flex flex-wrap mx-2">
        <div className="w-full flex justify-center items-start flex-col px-4 sm:w-1/2 lg:w-4/12">
          <div className="w-5/6">
            <Button href="/contact">¿Quiénes somos?</Button>
            <div className="h-48">
              <p className="text-md text-gray-900 mt-5">
                Unne es una plataforma de corretaje, donde los corredores puedan
                acceder a herramientas digitales que de otro modo seria difícil
                de acceder.
              </p>
            </div>
          </div>
        ...
        <div className="w-full flex justify-center items-start flex-col px-4 sm:w-1/2 lg:w-4/12">
          <div className="w-5/6">
            ...
            <div className="h-48">
              ...
              <p className="d-flex flex-col text-md text-gray-800 mt-1">
                ...
                <div className="flex justify-start items-center my-3">
                  <a
                    href="/"
                    class="text-dark bg-orange-400 text-white hover:bg-orange-600 hover:border-orange-600 mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="8"
                      height="16"
